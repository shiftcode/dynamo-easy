...
import { ModelWithAutogeneratedId } from "./models/complex.model"
...
} from "./models/model-with-custom-mapper.model"
...
describe("Mapper", () => {
  describe("should map single values", () => {
    describe("to db", () => {
      it("string", () => {
        let attrValue: AttributeValue = Mapper.toDbOne("foo")
      ...
      it("number", () => {
        let attrValue: AttributeValue = Mapper.toDbOne(3)
        expect(attrValue).toBeDefined()
      ...
      it("boolean", () => {
        let attrValue: AttributeValue = Mapper.toDbOne(false)
        expect(attrValue).toBeDefined()
      ...
      it("null", () => {
        let attrValue: AttributeValue = Mapper.toDbOne(null)
        expect(attrValue).toBeDefined()
      ...
      it("date (moment)", () => {
        const m = moment()
        let attrValue: AttributeValue = Mapper.toDbOne(m)
        expect(attrValue).toBeDefined()
      ...
      it("array -> SS (homogen, no duplicates)", () => {
        let attrValue: AttributeValue = Mapper.toDbOne(["foo", "bar"])
        expect(attrValue).toBeDefined()
      ...
      it("array -> L (homogen, no duplicates, explicit type)", () => {
        ...
        let attrValue: AttributeValue = Mapper.toDbOne(
          ["foo", "bar"],
          <any>propertyMetadata
        )
        expect(attrValue).toBeDefined()
      ...
      it("array -> L (heterogen, no duplicates)", () => {
        let attrValue: AttributeValue = Mapper.toDbOne(["foo", 56, true])
        expect(attrValue).toBeDefined()
        expect(keyOf(attrValue)).toBe("L")
        expect(attrValue.L).toBeDefined()
        expect(attrValue.L.length).toBe(3)
    ...
    describe("from db", () => {
      ...
      it("S -> Moment from type decoration", () => {
        ...
        const attrValue = { S: date.clone().utc().format() }
        const momentOb = Mapper.fromDbOne<moment.Moment>(
          attrValue,
          <any>propertyMetadata
        )
        expect(moment.isMoment(momentOb)).toBeTruthy()
      ...
      it("M", () => {
        ...
        const lastUpdatedDate: moment.Moment = moment(
          "2017-07-05",
          "YYYY-MM-DD"
        )
        const attrValue = {
    ...
    describe("to db", () => {
      describe("model class created with new", () => {
        ...
        beforeEach(() => {
          ...
          organization.awards = new Set([
            "good, better, shiftcode",
            "jus kiddin",
          ])
        ...
        describe("creates correct attribute map", () => {
          ...
          it("domains", () => {
            ...
            let domains: StringSetAttributeValue =
              organizationAttrMap.domains.SS
          ...
          it("random details", () => {
            ...
            let randomDetails: ListAttributeValue =
              organizationAttrMap.randomDetails.L
          ...
          it("employees", () => {
            ...
            expect(employee1["createdAt"].S).toBe(
              createdAtDateEmployee1.clone().utc().format()
            )
            ...
            expect(employee2["createdAt"].S).toBe(
              createdAtDateEmployee2.clone().utc().format()
            )
          })
          ...
          it("cities", () => {
            ...
            let citiesSS: StringSetAttributeValue =
              organizationAttrMap.cities.SS
          ...
          it("birthdays", () => {
            ...
            const birthdays: ListAttributeValue =
              organizationAttrMap.birthdays.L
            ...
            expect(birthday1["date"]["S"]).toBe(
              birthday1Date.clone().utc().format()
            )
            ...
            expect(birthday2["date"]["S"]).toBe(
              birthday2Date.clone().utc().format()
            )
      ...
      describe("model with custom mapper", () => {
        it("should map using the custom mapper", () => {
          ...
          const toDb: AttributeMap<ModelWithCustomMapperModel> = Mapper.toDb(
            model,
            ModelWithCustomMapperModel
          )
    ...
    describe("from db", () => {
      ...
      describe("model", () => {
        ...
        it("createdAtDate", () => {
          ...
          expect(
            (<moment.Moment>organization.createdAtDate).isValid()
          ).toBeTruthy()
          expect(
        ...
        it("lastUpdated", () => {
          ...
          expect(
            (<moment.Moment>organization.lastUpdated).isValid()
          ).toBeTruthy()
          expect(
        ...
        it("employees", () => {
          ...
          expect(
            moment.isMoment(organization.employees[0].createdAt)
          ).toBeTruthy()
          expect(
          ...
          expect(
            organization.employees[0].sortedSet instanceof Set
          ).toBeTruthy()
          ...
          expect(
            moment.isMoment(organization.employees[1].createdAt)
          ).toBeTruthy()
          expect(
          ...
          expect(
            organization.employees[1].sortedSet instanceof Set
          ).toBeTruthy()
        })
