import { AttributeValue, AttributeValueList, ListAttributeValue, MapAttributeValue, StringSetAttributeValue } from 'aws-sdk/clients/dynamodb'
  ...
  describe('should map single values', () => {
    describe('to db', () => {
      ...
      it('array -> L (homogen, no duplicates, explicit type)', () => {
        ...
        let attrValue: AttributeValue = Mapper.toDbOne(['foo', 'bar'], <any>propertyMetadata)
        expect(attrValue).toBeDefined()
      ...
      it('array -> L (homogen, complex type)', () => {
        let attrValue: AttributeValue = Mapper.toDbOne([new Employee('max', 25, moment(), null), new Employee('anna', 65, moment(), null)])
      ...
      it('set', () => {
        let attrValue: AttributeValue = Mapper.toDbOne(new Set(['foo', 'bar', 25]))
        expect(attrValue).toBeDefined()
        expect(keyOf(attrValue)).toBe('SS')
        expect(attrValue.SS[0]).toBe('foo')
        expect(attrValue.SS[1]).toBe('bar')
      ...
      it('set of employees', () => {
        ...
        let attrValue: AttributeValue = Mapper.toDbOne(new Set([<Employee>{ name: 'foo', age: 56, createdAt: cd }, <Employee>{ name: 'anna', age: 26, createdAt: cd2 }]))
      ...
      it('object (Employee created using Object literal)', () => {
        ...
        let attrValue: AttributeValue = Mapper.toDbOne(<Employee>{ name: 'foo', age: 56, createdAt: cr })
        expect(attrValue).toBeDefined()
      ...
      it('object (Employee created using constructor)', () => {
        ...
        let attrValue: AttributeValue = Mapper.toDbOne(new Employee('foo', 56, cr, []))
        expect(attrValue).toBeDefined()
        expect(keyOf(attrValue)).toBe('M')
    ...
    describe('to db', () => {
      describe('model class created with new', () => {
        ...
        beforeEach(() => {
          ...
          organization.birthdays = new Set([new Birthday(birthday1Date, 'ticket to rome', 'camper van'), new Birthday(birthday2Date, 'car', 'gin')])
        ...
        describe('creates correct attribute map', () => {
          ...
          it('domains', () => {
            ...
            let domains: StringSetAttributeValue = organizationAttrMap.domains.SS
          ...
          it('random details', () => {
            ...
            let randomDetails: ListAttributeValue = organizationAttrMap.randomDetails.L
      ...
      describe('model with autogenerated id', () => {
        it('should create an uuid', () => {
          const toDb: AttributeMap<ModelWithAutogeneratedId> = Mapper.toDb(new ModelWithAutogeneratedId(), ModelWithAutogeneratedId)
          expect(toDb.id).toBeDefined()
          expect(keyOf(toDb.id)).toBe('S')
