...
describe("Mapper", () => {
    ...
    describe("to db", () => {
      ...
      it("array -> L (homogen, complex type)", () => {
        let attrValue: AttributeValue = Mapper.mapToDbOne([
          new Employee("max", 25, moment()),
          new Employee("anna", 65, moment())
        ])
      ...
      it("object (Employee created using Object literal)", () => {
        ...
        let attrValue: AttributeValue = Mapper.mapToDbOne(
          <Employee>{ name: "foo", age: 56, createdAt: cr }
        )
        expect(attrValue).toBeDefined()
        ...
        expect(attrValue.M["createdAt"].S).toBe(
          cr.clone().utc().format(moment.defaultFormat)
        )
      })
  ...
  describe("to db model object literal (non-new)", () => {
    ...
    it("createdAt", () => {
      ...
      expect(organizationAttrMap.createdAtDate.S).toBe(
        createdAt.clone().utc().format(moment.defaultFormat)
      )
    })
    ...
    it("employees", () => {
      ...
      expect(employee1["createdAt"].S).toBe(
        createdAtDateEmployee1.clone().utc().format(moment.defaultFormat)
      )
    })
  })
  ...
  describe("to db model class created with new", () => {
    ...
    describe("creates correct attribute map", () => {
      ...
      it("awardWinningYears", () => {
        ...
        let awardWinningYearsNS: NumberSetAttributeValue =
          organizationAttrMap.awardWinningYears.NS
        expect(awardWinningYearsNS).toBeDefined()
        expect(awardWinningYearsNS.length).toBe(3)
        let years: string[] = Array.from(organization.awardWinningYears).map(
          year => `${year}`
        )
  ...
  describe("from db", () => {
    ...
    it("createdAtDate", () => {
      ...
      expect(
        (<moment.Moment>organization.createdAtDate).isSame(
          organization1CreatedAt
        )
      ).toBeTruthy()
    })
    ...
    it("lastUpdated", () => {
      ...
      expect(
        (<moment.Moment>organization.lastUpdated).isSame(
          organization1LastUpdated
        )
      ).toBeTruthy()
    })
    ...
    it("employees", () => {
      ...
      expect(
        (<moment.Moment>organization.employees[0].createdAt).isSame(
          organization1Employee1CreatedAt
        )
      ).toBeTruthy()
      ...
      expect(
        (<moment.Moment>organization.employees[1].createdAt).isSame(
          organization1Employee2CreatedAt
        )
      ).toBeTruthy()
    })
