...
export class ObjectMapper<T> implements MapperForType<any> {
  ...
  fromDb(val: AttributeValue, propertyMetadata?: PropertyMetadata<any>): any {
    return Mapper.fromDb(val.M, propertyMetadata && propertyMetadata.typeInfo && propertyMetadata.typeInfo.isCustom ? propertyMetadata.typeInfo.type : null)
  }

  toDb(value: any, propertyMetadata?: PropertyMetadata<any>): MapAttributeValue {
    return {
      M: Mapper.toDb<any>(value, propertyMetadata && propertyMetadata.typeInfo && propertyMetadata.typeInfo.isCustom ? propertyMetadata.typeInfo.type : null),
    }
  }
}
