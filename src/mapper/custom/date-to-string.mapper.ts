...
export class DateToStringMapper implements MapperForType<Date, StringAttribute> {
  fromDb(attributeValue: StringAttribute): Date {
    if (attributeValue.S) {
  ...
  toDb(modelValue: Date): StringAttribute {
